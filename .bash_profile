...
# USE: labs 
# current flatiron/labs/week# subfolder
function labs {
  cd /Users/$USER/Development/code/flatiron/labs/week08/$@
}
# Aliases
# =====================
  # LS
  ...
  # Screenshot
  alias sshot="screencapture -i ~/Desktop/scrcap.png"
...
# =====================
  ...
  # Case insensitive tabbing in Bash
